...
import { Logo, footerLinks, socialMedia } from '../constants';

const Footer = () => {
  return (
    <footer className="p-12 bg-gray-800 mt-[10rem]">
      <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
        <div className="flex flex-col items-start">
          <a href="/">
            <img src={Logo} alt="Logo" width={150} height={46} className="rounded-full" />
          </a>
